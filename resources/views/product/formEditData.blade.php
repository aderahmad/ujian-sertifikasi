  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="m-2 border p-2">
        <form action="{{ route('produk.updateProduk', $dataProduct->id) }}" method="post">
          @csrf
          {{-- input kode produk ########################################## --}}
          <div class="row my-2 mb-4">
            ...
            <div class="col-lg-4">
                ...
                <input type="text" name="kode_produk" id="kodeProduk" class="form-control @error('kode_produk') is-invalid @enderror" value="{{ old('kode_produk', $dataProduct->kode_produk) }}">
          ...
          <div class="row my-2 mb-4">
            ...
            <div class="col-lg-6">
                <input type="text" name="namaProduk" id="namaProduk" class="form-control @error('namaProduk') is-invalid @enderror" value="{{ old('namaProduk', $dataProduct->nama_produk) }}" >
                @error('namaProduk')
                <div class="invalid-feedback mb-0">
                    {{ $message }}
                </div>
          ...
          <div class="row my-2 mb-4">
            ...
            <div class="col-lg-4">
                <input type="text" name="hargaBeli" id="hargaBeli" class="form-control @error('hargaBeli') is-invalid @enderror" value="{{ old('hargaBeli', $dataProduct->harga_beli) }}" >
                @error('hargaBeli')
                <div class="invalid-feedback mb-0">
                    {{ $message }}
                </div>
            ...
            <div class="col-lg-4">
              <input type="text" name="hargaJual" id="hargaJual" class="form-control @error('hargaJual') is-invalid @enderror" value="{{ old('hargaJual', $dataProduct->harga_jual) }}" >
              @error('hargaJual')
              <div class="invalid-feedback mb-0">
                  {{ $message }}
              </div>
        ...
        <div class="row my-2 mb-4">
          ...
          <div class="col-lg-4">
            <select class="form-select" name="statusProduk" id="statusProduk" aria-label="Default select example">
              <option value="Tunai" {{ ($dataProduct->status_produk == 'Tunai') ? 'selected' : '' }}>Tunai</option>
              <option value="kredit" {{ ($dataProduct->status_produk == 'kredit') ? 'selected' : '' }}>Kredit</option>
              <option value="konsinyasi" {{ ($dataProduct->status_produk == 'konsinyasi') ? 'selected' : '' }}>Konsinyasi</option>
            </select>
              @error('statusProduk')
              <div class="invalid-feedback mb-0">
                  {{ $message }}
          ...
          <div class="col-lg-4">
            <select class="form-select" name="kelompokProduk" id="kelompokProduk" aria-label="Default select example">
              <option value="Sembako" {{ ($dataProduct->kelompok_produk == 'Sembako') ? 'selected' : '' }}>Sembako</option>
              <option value="Bangunan" {{ ($dataProduct->kelompok_produk == 'Bangunan') ? 'selected' : '' }}>Bangunan</option>
              <option value="Jasa" {{ ($dataProduct->kelompok_produk == 'Jasa') ? 'selected' : '' }}>Jasa</option>
            </select>
        ...
        <div class="row my-2 mb-4 justify-content-end">
         <div class="col-lg-2 align-self-end">
          ...
          <div class="col-lg-4 align-self-end">
            <input type="text" name="stok" id="stok" class="form-control @error('stok') is-invalid @enderror" value="{{ old('stok', $dataProduct->stok) }}" >
            @error('stok')
            <div class="invalid-feedback mb-0">
                {{ $message }}
            </div>
